...
class BumbleBlock_Subscriber(object):
    ...
    def callback(self,msg):
        ...
        self.orientation = [msg.orientation.x,msg.orientation.y,
...
import rospy
from geometry_msgs.msg import PoseStamped
# from .fetch_move_clients import MoveBaseClient, FollowTrajectoryClient,PointHeadClient, GraspingClient
# from chart_fetch.fetch_move_clients  import MoveBaseClient, FollowTrajectoryClient,PointHeadClient, GraspingClient

# from chart_fetch import fetch_move_clients


if __name__ == "__main__":
    # Create a node
    rospy.init_node("fetch_get_bumbleball")
    ...
    # rospy.loginfo(f"Moving to bumble block @ pos = {BB.position}")
    # move_base.goto(*BB.position)
    rospy.loginfo(f"Moving to bumble block @ pos ")
